...
![tag](https://img.shields.io/badge/tag-v1.24.0-brightgreen.svg)
...
This repository provides the STM32Cube **WPAN** Middleware Library, **common to every** STM32Cube MCU firmware that supports it.
